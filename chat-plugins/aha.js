...
exports.commands = {
	...
	opensource: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			"- <a href=\"https://github.com/DeathlyPlays/Exiled\">Lemuria Server Code</a><br />" +
	...
	credits: function (target, room, user) {
		let popup = "|html|" + "<font size=5 color=#10284c><u><b>Créditos do Leaf:</b></u></font><br />" +
			"<br />" +
			"<u><b>Fundadores e Vice-Fundadores:</u></b><br />" +
			"<u><b>Desenvolvedores, programadores, tradutores de programas:</b></u><br />" +
			"- " + Exiled.nameColor('Besteira', true) + " (Programador, Desenvolvedor, Tradutor de Arquivos,Fundador)<br />" +
			"<u><b>Auxiliares e apoiadores:</b></u><br />" +
                        "- " + Exiled.nameColor('Dragonitezin', true) + " (Apoiador, auxiliador)<br />" +
                        "- " + Exiled.nameColor('AsrielPlayBoy', true) + " (Apoiador, auxiliador)<br />" +
                        "<br />" +
			"<u><b>Agradecimentos Especiais:</b></u><br />" +
			"- Nossos membros da Staff<br />" +
			"- Nossos usuários<br />";
		user.popup(popup);
	},
};