...
class Survey {
	...
	generateQuestion() {
		...
		output += '<div style="margin-top: 5px"><button class="button" value="/survey answer" name="send" title="Answer the survey."><b>Responder</b></button></div>';
...
exports.commands = {
	...
	survey: {
		...
		answerhelp: ["/survey answer [O que pretende falar] ou /sa [answer] - Diga Sua Opinião."],
