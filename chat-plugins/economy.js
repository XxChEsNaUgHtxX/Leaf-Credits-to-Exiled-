...
function getShopDisplay(shop) {
	let display = "<center><img src=https://play.pokemonshowdown.com/sprites/xyani/chespin.gif><img src=https://cdn.bulbagarden.net/upload/f/f6/Floaroma_Flower_shop_DPPt.png width=300> <img src=https://play.pokemonshowdown.com/sprites/xyani/chesnaught.gif></center><br><div' + (!this.isOfficial ? ' class=infobox-limited' : '') + '><table style='background: #000; border-color: #green; border-radius: 8px' border='1' cellspacing='0' cellpadding='5' width='100%'>" +
		"<tbody><tr><th><font color=#green face=courier>Item</font></th><th><font color=green face=courier>Description</font></th><th><font color=green face=courier>Price</font></th></tr>";
	let start = 0;
	while (start < shop.length) {
		display += "<tr>" +
			"<td align='center'><button name='send' style='background: #000; border-radius: 5px; border: solid, 1px, green; font-size: 11px; padding: 5px 10px' value='/buy " + shop[start][0] + "'><font color=green face=courier><b>" + shop[start][0] + "</b></font></button>" + "</td>" +
			"<td align='center'><font color=green face=courier>" + shop[start][1] + "</font></td>" +
			"<td align='center'><font color=green face=courier>" + shop[start][2] + "</font></td>" +
			"</tr>";
		start++;
	}
